...
const Products = ({ img, name, description, price}) => {
    ...
    <>
        ...
        */}
        ...
        {/*Props estructurados. Puede asignar diferentes propiedades a un div, sin tener que generar muchos props, solamente usando la palabra reservada "props" como parametro de la funcion 
        *Quiero modificar varias propiedades , puedo mandar a llamar a las props dentro de cada elemento, como si fueran metodos   */}
        {/*<div className="cards">
            <div className="products--card">
